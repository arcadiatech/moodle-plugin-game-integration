...
$functions = array(
    ...
    'mod_url_save_score' => array(
        'classname'     => 'mod_url_external',
        'methodname'    => 'save_score',
        'description'   => 'Save a user score',
        'type'          => 'write',
        'capabilities'  => '',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    'mod_url_get_user_max_score' => array(
        'classname'     => 'mod_url_external',
        'methodname'    => 'get_user_max_score',
        'description'   => 'Returns the max score.',
        'type'          => 'read',
        'capabilities'  => '',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE),
    ),
